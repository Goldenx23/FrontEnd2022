                            ...
                            <div className="row">
                                ...
                                <div className="col-4">
                                    <div className="form-group">
                                        ...
                                        <input type="number" name="nickname" id="nickname" className="form-control" defaultValue={userData.nickname} required />
                                    </div>
                                </div>
                                <div className="col-4">
                                    <div className="form-group">
                                        <label htmlFor="password" className="control-label">contraseña</label>
                                        <input type="number" name="password" id="password" className="form-control" defaultValue={userData.password} required />
                                    </div>
                                </div>
                                <div className="col-4">
                                    <div className="form-group">
                                        <label htmlFor="level" className="control-label">level</label>
                                        <input type="number" name="level" id="level" className="form-control" defaultValue={userData.level} required />
                                    </div>
                                </div>
                            </div>
